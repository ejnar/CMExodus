...
public class CmItemResource {
    ...
    @Timed
    public ResponseEntity<CmItemDTO> createCmItem(@Valid @RequestBody CmItemDTO cmItemDTO) throws URISyntaxException {
    ...
    @PutMapping("/cm-items")
    @Timed
    public ResponseEntity<CmItemDTO> updateCmItem(@Valid @RequestBody CmItemDTO cmItemDTO) throws URISyntaxException {
