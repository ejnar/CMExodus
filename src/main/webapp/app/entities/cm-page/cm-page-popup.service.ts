...
@Injectable()
export class CmPagePopupService {
            ...
            if (id) {
                this.cmPageService.find(id)
                    .subscribe((cmPageResponse: HttpResponse<CmPage>) => {
                        const cmPage: CmPage = cmPageResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.cmPageModalRef(component, new CmPage());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    cmPageModalRef(component: Component, cmPage: CmPage): NgbModalRef {
