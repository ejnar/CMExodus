...
@Injectable()
export class CmTopicPopupService {
            ...
            if (id) {
                this.cmTopicService.find(id)
                    .subscribe((cmTopicResponse: HttpResponse<CmTopic>) => {
                        const cmTopic: CmTopic = cmTopicResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.cmTopicModalRef(component, new CmTopic());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    cmTopicModalRef(component: Component, cmTopic: CmTopic): NgbModalRef {
