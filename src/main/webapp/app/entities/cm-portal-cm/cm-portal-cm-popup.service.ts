...
@Injectable()
export class CmPortalCmPopupService {
            ...
            if (id) {
                this.cmPortalService.find(id)
                    .subscribe((cmPortalResponse: HttpResponse<CmPortalCm>) => {
                        const cmPortal: CmPortalCm = cmPortalResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.cmPortalModalRef(component, new CmPortalCm());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    cmPortalModalRef(component: Component, cmPortal: CmPortalCm): NgbModalRef {
