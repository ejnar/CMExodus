...
import se.cm.exodus.config.audit.AuditEventConverter;
import se.cm.exodus.domain.PersistentAuditEvent;
...
import static se.cm.exodus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
