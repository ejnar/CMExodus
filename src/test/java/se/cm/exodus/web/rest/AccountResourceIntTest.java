...
import se.cm.exodus.config.Constants;
import se.cm.exodus.CmExodusApp;
import se.cm.exodus.domain.Authority;
import se.cm.exodus.domain.User;
import se.cm.exodus.repository.AuthorityRepository;
import se.cm.exodus.repository.UserRepository;
import se.cm.exodus.security.AuthoritiesConstants;
import se.cm.exodus.service.MailService;
import se.cm.exodus.service.dto.UserDTO;
import se.cm.exodus.web.rest.errors.ExceptionTranslator;
import se.cm.exodus.web.rest.vm.KeyAndPasswordVM;
import se.cm.exodus.web.rest.vm.ManagedUserVM;
