...
describe('Service Tests', () => {
    ...
    describe('CmPageAuthorityCm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CmPageAuthorityCmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cm-page-authorities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CmPageAuthorityCm', () => {
